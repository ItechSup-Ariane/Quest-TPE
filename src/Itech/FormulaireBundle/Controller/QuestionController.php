...
use Itech\FormulaireBundle\Entity\Question;
use Itech\FormulaireBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechFormulaireBundle:Question')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechFormulaireBundle:Question:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechFormulaireBundle:Question')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechFormulaireBundle:Question:edit.html.twig")
     */
