...
use Itech\FormulaireBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechFormulaireBundle:Categorie')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechFormulaireBundle:Categorie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechFormulaireBundle:Categorie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechFormulaireBundle:Categorie:edit.html.twig")
     */
