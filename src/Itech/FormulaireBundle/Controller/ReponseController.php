...
use Itech\FormulaireBundle\Form\ReponseType;
...
class ReponseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechFormulaireBundle:Reponse')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechFormulaireBundle:Reponse:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechFormulaireBundle:Reponse')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechFormulaireBundle:Reponse:edit.html.twig")
     */
