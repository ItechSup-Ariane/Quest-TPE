...
use Itech\FormulaireBundle\Form\QuestionnaireType;
...
class QuestionnaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechFormulaireBundle:Questionnaire')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechFormulaireBundle:Questionnaire:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechFormulaireBundle:Questionnaire')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechFormulaireBundle:Questionnaire:edit.html.twig")
     */
